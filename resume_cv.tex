...
\name{\textbf{Deepak}}{Pruthi}
\address{HNO 838/A Gwalla Mohalla Lakkar Bazar Ludhiana, Punjab - 141008}
\mobile{(+91) 9653338697}

\email{dpruthi16@gmail.com}
%\homepage{www.posquit0.com}
\github{dpruthi}
\linkedin{Deepak Pruthi}

%\extrainfo{Blog:-https://gurnoor30.wordpress.com/}
%\skype{skypeid}
%\stackoverflow{SOid}{SOname}
\wordpress{tacitusdeep}
%\linkedin{linkedin name}
%\reddit{reddit account}
\homepage{dpruthi.github.io}
%\extrainfo{test} % Other text you want to include on this line

\position{IT Engineer } % Your expertise/fields
\quote{Java Engineer, Future Android Developer, Living the dream.}
 %who dont"} % A quote or statement

\makecvfooter{\today}{Deepak Pruthi~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
